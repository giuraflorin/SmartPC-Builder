...
var Component = /** @class */ (function () {
    ...
    Component.prototype.setMultip$nstances = function (multip$nstances) {
        this.multip$nstances = multip$nstances;
        return this;
    };
...
var Provider = /** @class */ (function () {
     ...
     * if this.component.multip$nstances is true.
     */
    Provider.prototype.get = function (identifier) {
        // if multip$nstances is not supported, use the default name
    ...
    Provider.prototype.setComponent = function (component) {
        ...
        try {
            ...
            // NOTE: if this.multip$nstances is false, only the default instance will be created
    ...
    Provider.prototype.normalizeInstanceIdentifier = function (identifier) {
        if (identifier === void 0) { identifier = DEFAULT_ENTRY_NAME; }
        if (this.component) {
            return this.component.multip$nstances ? identifier : DEFAULT_ENTRY_NAME;
        }
        else {
