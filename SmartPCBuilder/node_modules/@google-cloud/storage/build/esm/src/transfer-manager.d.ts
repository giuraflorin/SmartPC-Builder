...
export interface DownloadFi$nChunksOptions {
    concurrencyLimit?: number;
...
export interface UploadFi$nChunksOptions {
    concurrencyLimit?: number;
    chunkSizeBytes?: number;
    uploadName?: string;
    maxQueueSize?: number;
...
export declare class TransferManager {
     ...
     *
     */
    downloadFi$nChunks(fileOrName: File | string, options?: DownloadFi$nChunksOptions): Promise<void | DownloadResponse>;
    /**
     ...
     *
     */
    uploadFi$nChunks(filePath: string, options?: UploadFi$nChunksOptions, generator?: MultiPartHelperGenerator): Promise<GaxiosResponse | undefined>;
