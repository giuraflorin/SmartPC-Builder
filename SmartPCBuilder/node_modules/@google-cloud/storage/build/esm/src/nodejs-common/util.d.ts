...
export interface GoogleErrorBody {
    code: number;
    errors?: Goog$nnerError[];
    response: r.Response;
    message?: string;
}
export interface Goog$nnerError {
    reason?: string;
    message?: string;
}
...
export declare class ApiError extends Error {
     ...
     * @param {Goog$nnerError[]} [errors] Inner errors, if any.
     * @returns {string}
     */
    static createMultiErrorMessage(err: GoogleErrorBody, errors?: Goog$nnerError[]): string;
}
/**
