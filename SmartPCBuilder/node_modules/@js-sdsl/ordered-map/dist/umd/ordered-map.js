...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var TreeNodeEnab$ndex = /** @class */function (_super) {
      __extends(TreeNodeEnab$ndex, _super);
      function TreeNodeEnab$ndex() {
       ...
       * @returns TreeNode about moved to original position after rotation.
       */
      TreeNodeEnab$ndex.prototype._rotateLeft = function () {
       ...
       * @returns TreeNode about moved to original position after rotation.
       */
      TreeNodeEnab$ndex.prototype._rotateRight = function () {
        var parent = _super.prototype._rotateRight.call(this);
        this._recount();
        parent._recount();
        return parent;
      };
      TreeNodeEnab$ndex.prototype._recount = function () {
        this._subTreeSize = 1;
        if (this._left) {
    ...
    var TreeContainer = /** @class */function (_super) {
       ...
       * @internal
       */
      function TreeContainer(cmp, enab$ndex) {
        if (cmp === void 0) {
          cmp = function (x, y) {
            if (x < y) return -1;
            if (x > y) return 1;
        ...
        _this._cmp = cmp;
        _this.enab$ndex = enab$ndex;
        _this._TreeNodeClass = enab$ndex ? TreeNodeEnab$ndex : TreeNode;
    ...
    var TreeIterator = /** @class */function (_super) {
      ...
      Object.defineProperty(TreeIterator.prototype, "index", {
         ...
         *              <strong>Note:</strong>
         *              This function only takes effect when the specified tree container `enab$ndex = true`.
    ...
    var OrderedMap = /** @class */function (_super) {
       ...
       * @param enab$ndex - Whether to enable iterator indexing function.
       * @example
       * new OrderedMap();
       ...
       */
      function OrderedMap(container, cmp, enab$ndex) {
        if (container === void 0) {
          container = [];
        }
        var _this = _super.call(this, cmp, enab$ndex) || this;
        var self = _this;
