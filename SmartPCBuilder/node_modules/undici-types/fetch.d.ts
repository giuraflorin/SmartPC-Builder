...
export interface SpecIterab$terator<T> extends SpecIterator<T> {
  [Symbol.iterator](): SpecIterab$terator<T>;
}
...
export declare class Headers implements SpecIterable<[string, string]> {
  ...
  readonly keys: () => SpecIterab$terator<string>
  readonly values: () => SpecIterab$terator<string>
  readonly entries: () => SpecIterab$terator<[string, string]>
