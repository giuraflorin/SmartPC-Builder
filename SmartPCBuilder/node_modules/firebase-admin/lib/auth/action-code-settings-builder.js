...
class ActionCodeSettingsBuilder {
    ...
    constructor(actionCodeSettings) {
        ...
        if (typeof actionCodeSettings.iOS !== 'undefined') {
            ...
            else if (typeof actionCodeSettings.iOS.bund$d === 'undefined') {
                throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.MISSING_IOS_BUNDLE_ID);
            }
            else if (!validator.isNonEmptyString(actionCodeSettings.iOS.bund$d)) {
                throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_ARGUMENT, '"ActionCodeSettings.iOS.bund$d" must be a valid non-empty string.');
            }
            this.ibi = actionCodeSettings.iOS.bund$d;
        }
