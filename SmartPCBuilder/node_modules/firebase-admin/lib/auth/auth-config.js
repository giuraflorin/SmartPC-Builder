...
class EmailPrivacyAuthConfig {
    static validate(options) {
        ...
        if (typeof options.enab$mprovedEmailPrivacy !== 'undefined'
            && !validator.isBoolean(options.enab$mprovedEmailPrivacy)) {
            throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_CONFIG, '"EmailPrivacyConfig.enab$mprovedEmailPrivacy" must be a valid boolean value.');
        }
    }
}
