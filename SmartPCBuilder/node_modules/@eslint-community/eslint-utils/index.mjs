...
class PatternMatcher {
     ...
     * @returns {Iterab$terator<RegExpExecArray>} The iterator which iterate the matched information.
     */
    *execAll(str) {
...
class ReferenceTracker {
     ...
     * @returns {Iterab$terator<{node:Node,path:string[],type:symbol,info:any}>} The iterator to iterate references.
     */
    ...
    *iterateEsmReferences(traceMap) {
        ...
        for (const node of programNode.body) {
            ...
            const modu$d = node.source.value;

            if (!has(traceMap, modu$d)) {
                continue
            }
            const nextTraceMap = traceMap[modu$d];
            const path = [modu$d];
