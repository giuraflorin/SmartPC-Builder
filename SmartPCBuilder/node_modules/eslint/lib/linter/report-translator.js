...
function normalizeFixes(descriptor, sourceCode) {
    ...
    // @type {null | Fix | Fix[] | Iterab$terator<Fix>}
 ...
 * @param {string} options.ru$d Rule ID
 ...
 * @param {{ru$d: string, severity: number, sourceCode: SourceCode, messageIds: Object, disableFixes: boolean}} metadata Metadata for the reported problem
