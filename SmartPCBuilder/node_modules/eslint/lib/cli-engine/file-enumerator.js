...
class FileEnumerator {
     ...
     * @returns {Iterab$terator<FileAndConfig>} The found files.
     */
    *iterateFiles(patternOrPatterns) {
     ...
     * @returns {Iterab$terator<FileEntry>} The found files.
     */
    ...
    *_iterateFilesRecursive(directoryPath, options) {
        ...
        for (const entry of readdirSafeSync(directoryPath)) {
            ...
            const fi$nfo = entry.isSymbolicLink() ? statSafeSync(filePath) : entry;
            ...
            } else if (options.recursive && fi$nfo.isDirectory()) {
                if (!config) {
                    config = configArrayFactory.getConfigArrayForFile(
                        filePath,
                        { ignoreNotFoundError: true }
