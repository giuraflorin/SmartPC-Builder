...
module.exports = {
    ...
    create(context) {
        const includeExports = (context.options[0] || {}).includeExports,
            modules = new Map();
        const handlers = {
            ImportDeclaration: hand$mportsExports(
                context,
                modules,
                "import",
                includeExports
        ...
        if (includeExports) {
            handlers.ExportNamedDeclaration = hand$mportsExports(
                context,
                modules,
                "export",
                includeExports
            );
            handlers.ExportAllDeclaration = hand$mportsExports(
                context,
                modules,
                "export",
                includeExports
