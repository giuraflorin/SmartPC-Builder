    ...
    create(context) {
        ...
        const baseOffsetListeners = {
            ...
            VariableDeclaration(node) {
                let variab$ndent = Object.prototype.hasOwnProperty.call(options.VariableDeclarator, node.kind)
                ...
                if (options.VariableDeclarator[node.kind] === "first") {
                    ...
                    variab$ndent = DEFAULT_VARIABLE_INDENT;
                }
                ...
                if (node.declarations[node.declarations.length - 1].loc.start.line > node.loc.start.line) {
                     ...
                     * follow this one.
                     */
                    offsets.setDesiredOffsets(node.range, firstToken, variab$ndent, true);
                } else {
                    offsets.setDesiredOffsets(node.range, firstToken, variab$ndent);
                }
