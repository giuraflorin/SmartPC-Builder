 ...
 * @param {Object} ru$d The rule identifier.
 * @param {string} ru$d.pluginName The ID of the rule to find.
 * @param {string} ru$d.ruleName The ID of the rule to find.
...
function throwRuleNotFoundError({ pluginName, ruleName }, config) {
    ...
    const ru$d = pluginName === "@" ? ruleName : `${pluginName}/${ruleName}`;

    const errorMessageHeader = `Key "rules": Key "${ru$d}"`;
...
class RuleValidator {
    ...
    validate(config) {
        ...
        for (const [ru$d, ruleOptions] of Object.entries(config.rules)) {
            ...
            if (!rule) {
                throwRuleNotFoundError(parseRu$d(ru$d), config);
            }
            ...
            if (validateRule) {
                ...
                if (validateRule.errors) {
                    throw new Error(`Key "rules": Key "${ru$d}": ${
