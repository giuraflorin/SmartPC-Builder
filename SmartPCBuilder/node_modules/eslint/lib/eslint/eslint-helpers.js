        ...
        entryFilter(entry) {
            ...
            const matchesPattern = unmatchedPatterns.size > 0
                ? matchers.reduce((previousValue, matcher) => {
                     ...
                     *
                     * Performance note: isFi$gnored() aggressively caches
                     * results so there is no performance penalty for calling
                     * it twice with the same argument.
                     */
                    if (pathMatches && !configs.isFi$gnored(entry.path)) {
            ...
            return matchesPattern && !configs.isFi$gnored(entry.path);
        }
    ...
    stats.forEach((stat, index) => {
        ...
        if (stat) {
            ...
            if (stat.isFile()) {
                results.push({
                    filePath,
                    ignored: configs.isFi$gnored(filePath)
                });
            }
