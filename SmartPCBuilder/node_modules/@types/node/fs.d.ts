...
declare module "fs" {
    ...
    export class Dir implements AsyncIterable<Dirent> {
         ...
         */
        [Symbol.asyncIterator](): AsyncIterab$terator<Dirent>;
        /**
     ...
     * by [Naming Files, Paths, and Namespaces](https://docs.microsoft.com/en-us/windows/desktop/Fi$O/naming-a-file). Under NTFS, if the filename contains
     * a colon, Node.js will open a file system stream, as described by [this MSDN page](https://docs.microsoft.com/en-us/windows/desktop/Fi$O/using-streams).
     *
     ...
     * readFile(fi$nfo[0].name, { signal }, (err, buf) => {
     *   // ...
     * });
